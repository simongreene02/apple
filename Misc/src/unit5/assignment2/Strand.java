...
public class Strand {
	...
	public void setMulti() {
		...
		int index = 0;
		for (Light light : strand) {
			light.setColor(colors[index++ % colors.length]);
		}
		/* missing code */
	}
	...
	public void burnOut(int i) {
		if (i >= strand.size() || i < 0) {
			throw new IllegalArgumentException(
					"The value you entered was either higher than the length of the list or lower than zero.");
		}
	...
	public static void main(String[] args) {
		...
		if (strand1.strand.size() == 1)
			...
			System.out.println("*** FAIL: Strand() creates a list of size " + strand1.strand.size()
		...
		if (emptyStrand.strand.size() == 1)
			...
			System.out.println("*** FAIL: Strand(0)  creates a list of size " + emptyStrand.strand.size()
					+ ", when a list of size 1 is expected.");
		...
		if (negativeStrand.strand.size() == 1)
			...
			System.out.println("*** FAIL: Strand(-7) creates a list of size " + negativeStrand.strand.size()
					+ ", when a list of size 1 is expected.");
		...
		if (strandWithFiveBulbs.strand.size() == 5)
			...
			System.out.println("*** FAIL: Strand(5) creates a list of size " + strandWithFiveBulbs.strand.size()
